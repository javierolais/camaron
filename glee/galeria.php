...
<div id="classGaleria" class="wrapper">
		<?php 
			 ...
			 $imagen=opendir("imagen/personajes/"); 
			 //leer archivos 
			 while($archivo=readdir($imagen)) 
			 { 
			 $ext=substr($archivo,-3); 
			 //si la extension del archivo es correcta muestra la imagen 
			 if(in_array($ext,$arr_ext)) 
			 { 
			 echo '<a href="/imagen/personajes/'.$archivo.'" rel="lightbox[roadtrip]"> <center> <br> <img src="/imagen/personajes/'.$archivo.'" width="600" height="550"</center></a>'; 
			 echo '<br>';
			 } 
			 } 
		?> 
